...
mytouchend:function(){
  if (Math.abs(165.5-this.data.x)<6||(Math.abs(182.5-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(165.5-this.data.x1)<6||(Math.abs(182.5-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:165.5,
    y1:182.5,
  ...
  if (Math.abs(165.5-this.data.x2)<6||(Math.abs(182.5-this.data.y2))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:165.5,
    y2:182.5,
...
jishu:function(){
  if(this.data.x==165.5&this.data.y==182.5){
