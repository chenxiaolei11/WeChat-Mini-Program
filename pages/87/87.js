...
mytouchend:function(){
  if (Math.abs(35.2-this.data.x)<6||(Math.abs(162.4-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(35.2-this.data.x1)<6||(Math.abs(162.4-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:35.2,
    y1:162.4,
  ...
  if ((Math.abs(35.2-this.data.x2)<6)||((Math.abs(162.4-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:35.2,
    y2:162.4,
  ...
  if (Math.abs(35.2-this.data.x3)<6||(Math.abs(162.4-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:35.2,
    y3:162.4,
  ...
  if (Math.abs(35.2-this.data.x4)<3||(Math.abs(162.4-this.data.y4))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:35.2,
    y4:162.4,
  ...
  if (Math.abs(35.2-this.data.x5)<3||(Math.abs(162.4-this.data.y5))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x5:35.2,
    y5:162.4,
  ...
  if (Math.abs(35.2-this.data.x6)<3||(Math.abs(162.4-this.data.y6))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x6:35.2,
    y6:162.4,
  ...
  if (Math.abs(35.2-this.data.x7)<3||(Math.abs(162.4-this.data.y7))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x7:35.2,
    y7:162.4,
  ...
  if (Math.abs(35.2-this.data.x8)<3||(Math.abs(162.4-this.data.y8))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x8:35.2,
    y8:162.4,
...
jishu:function(){
  if(this.data.x4==35.2&&this.data.y4==162.4){
