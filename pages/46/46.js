...
mytouchend:function(){
  if (Math.abs(165.6-this.data.x)<6||(Math.abs(161.6-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(165.6-this.data.x1)<6||(Math.abs(161.6-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:165.6,
    y1:161.6,
  ...
  if ((Math.abs(165.6-this.data.x2)<6)||((Math.abs(161.6-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:165.6,
    y2:161.6,
  ...
  if (Math.abs(165.6-this.data.x3)<6||(Math.abs(161.6-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:165.6,
    y3:161.6,
  ...
  if (Math.abs(165.6-this.data.x4)<6||(Math.abs(161.6-this.data.y4))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:165.6,
    y4:161.6,
...
jishu:function(){
  if(this.data.x4==165.6&&this.data.y4==161.6){
