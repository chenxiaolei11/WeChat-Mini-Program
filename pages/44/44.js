...
mytouchend:function(){
  if (Math.abs(192.8-this.data.x)<6||(Math.abs(178.4-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(192.8-this.data.x1)<6||(Math.abs(178.4-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:192.8,
    y1:178.4,
  ...
  if ((Math.abs(180-this.data.x2)<6)||((Math.abs(164.8-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:180,
    y2:164.8,
  ...
  if (Math.abs(168-this.data.x3)<6||(Math.abs(152.8-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:168,
    y3:152.8,
...
jishu:function(){
  if(this.data.x1==192.8&&this.data.y1==178.4){
