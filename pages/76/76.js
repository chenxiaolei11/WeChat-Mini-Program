...
mytouchend:function(){
  if (Math.abs(183.1-this.data.x)<6||(Math.abs(161.6-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(183.1-this.data.x1)<6||(Math.abs(161.6-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:183.1,
    y1:161.6,
  ...
  if ((Math.abs(183.1-this.data.x2)<6)||((Math.abs(161.6-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:183.1,
    y2:161.6,
  ...
  if (Math.abs(183.1-this.data.x3)<6||(Math.abs(161.6-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:183.1,
    y3:161.6,
  ...
  if (Math.abs(183.1-this.data.x4)<3||(Math.abs(161.6-this.data.y4))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:183.1,
    y4:161.6,
  ...
  if (Math.abs(183.1-this.data.x5)<3||(Math.abs(161.6-this.data.y5))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x5:183.1,
    y5:161.6,
  ...
  if (Math.abs(183.1-this.data.x6)<3||(Math.abs(161.6-this.data.y6))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x6:183.1,
    y6:161.6,
...
jishu:function(){
  if(this.data.x4==183.1&&this.data.y4==161.6){
