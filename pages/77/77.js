...
mytouchend:function(){
  if (Math.abs(192.8-this.data.x)<6||(Math.abs(179.2-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(192.8-this.data.x1)<6||(Math.abs(179.2-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:192.8,
    y1:179.2,
  ...
  if ((Math.abs(192.8-this.data.x2)<6)||((Math.abs(179.2-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:192.8,
    y2:179.2,
  ...
  if (Math.abs(192.8-this.data.x3)<6||(Math.abs(179.2-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:192.8,
    y3:179.2,
  ...
  if (Math.abs(192.8-this.data.x4)<3||(Math.abs(179.2-this.data.y4))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:192.8,
    y4:179.2,
  ...
  if (Math.abs(184.8-this.data.x5)<3||(Math.abs(170.4-this.data.y5))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x5:184.8,
    y5:170.4,
  ...
  if (Math.abs(184.8-this.data.x6)<3||(Math.abs(170.4-this.data.y6))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x6:184.8,
    y6:170.4,
...
jishu:function(){
  if(this.data.x2==192.8&&this.data.y2==179.2){
