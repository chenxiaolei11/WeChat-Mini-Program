...
mytouchend:function(){
  if ((Math.abs(192.8-this.data.x))<6||(Math.abs(161.6-this.data.y))<6){
...
if ((Math.abs(192.8-this.data.x2))<6||(Math.abs(161.6-this.data.y2))<6){
  var that=this;  //当小于2px的可接受阈值时，验证成功
that.setData({
x2:192.8,
y2:161.6,
...
jishu:function(){
  if(this.data.x2==192.8&this.data.y2==161.6){
