...
mytouchend:function(){
  if (Math.abs(165.6-this.data.x)<6||(Math.abs(138.4-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(165.6-this.data.x1)<6||(Math.abs(138.4-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:165.6,
    y1:138.4,
  ...
  if (Math.abs(165.6-this.data.x2)<6||(Math.abs(138.4-this.data.y2))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:165.6,
    y2:138.4,
  ...
  if (Math.abs(165.6-this.data.x3)<6||(Math.abs(138.4-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:165.6,
    y3:138.4,
...
jishu:function(){
  if(this.data.x3==165.6&&this.data.y3==138.4){
