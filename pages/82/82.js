...
mytouchend:function(){
  if (Math.abs(196-this.data.x)<6||(Math.abs(168-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(196-this.data.x1)<6||(Math.abs(168-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:196,
    y1:168,
  ...
  if ((Math.abs(196-this.data.x2)<6)||((Math.abs(168-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:196,
    y2:168,
  ...
  if (Math.abs(196-this.data.x3)<6||(Math.abs(168-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:196,
    y3:168,
  ...
  if (Math.abs(196-this.data.x4)<3||(Math.abs(168-this.data.y4))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:196,
    y4:168,
  ...
  if (Math.abs(196-this.data.x5)<3||(Math.abs(168-this.data.y5))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x5:196,
    y5:168,
  ...
  if (Math.abs(196-this.data.x6)<3||(Math.abs(168-this.data.y6))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x6:196,
    y6:168,
...
jishu:function(){
  if(this.data.x4==196&&this.data.y4==168){
