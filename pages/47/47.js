...
mytouchend:function(){
  if (Math.abs(166.4-this.data.x)<6||(Math.abs(160.8-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(166.4-this.data.x1)<6||(Math.abs(160.8-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:166.4,
    y1:160.8,
  ...
  if ((Math.abs(166.4-this.data.x2)<6)||((Math.abs(160.8-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:166.4,
    y2:160.8,
  ...
  if (Math.abs(166.4-this.data.x3)<6||(Math.abs(160.8-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:166.4,
    y3:160.8,
  ...
  if (Math.abs(166.4-this.data.x4)<6||(Math.abs(160.8-this.data.y4))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:166.4,
    y4:160.8,
...
jishu:function(){
  if(this.data.x2==166.4&&this.data.y2==160.8){
