...
mytouchend:function(){
  if (Math.abs(196-this.data.x)<6||(Math.abs(168.8-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(196-this.data.x1)<6||(Math.abs(168.8-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:196,
    y1:168.8,
  ...
  if ((Math.abs(196-this.data.x2)<6)||((Math.abs(168.8-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:196,
    y2:168.8,
  ...
  if (Math.abs(196-this.data.x3)<6||(Math.abs(168.8-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:196,
    y3:168.8,
  ...
  if (Math.abs(196-this.data.x4)<6||(Math.abs(168.8-this.data.y4))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:196,
    y4:168.8,
...
jishu:function(){
  if(this.data.x2==196&&this.data.y2==168.8){
