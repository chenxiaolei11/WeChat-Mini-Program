...
mytouchend:function(){
  if (Math.abs(192.8-this.data.x)<6||(Math.abs(160-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(192.8-this.data.x1)<6||(Math.abs(160-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:192.8,
    y1:160,
  ...
  if (Math.abs(192.8-this.data.x2)<6||(Math.abs(160-this.data.y2))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:192.8,
    y2:160,
...
jishu:function(){
  if(this.data.x2==192.8&this.data.y2==160){
