...
jishu:function(){
  if(this.data.x==36&&this.data.y==161.6){
...
var that=this
  ...
        success: function (res) {
    ...
    var x1=152*windowWidth/320;
     var y1=325*windowHeight/568;  
    
    var x2=4*windowWidth/320;
     var y2=407*windowHeight/568;    
     
    var x3=152*windowWidth/320;
     var y3=407*windowHeight/568;   
    
    var x4=4*windowWidth/320;
     var y4=497*windowHeight/568;    

    var x5=152*windowWidth/320;
     var y5=497*windowHeight/568;  
          that.setData({
          x:x,
          y:y,
           x1:x1,
