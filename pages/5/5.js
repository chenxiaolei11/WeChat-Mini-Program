...
mytouchend:function(){
  if (Math.abs(194.4-this.data.x)<6||(Math.abs(161.6-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(194.4-this.data.x1)<6||(Math.abs(161.6-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:194.4,
    y1:161.6,
...
jishu:function(){
  if(this.data.x1==194.4&this.data.y1==161.6){
