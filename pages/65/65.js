...
mytouchend:function(){
  ...
  if (Math.abs(35.2-this.data.x4)<6||(Math.abs(160.8-this.data.y4))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:35.2,
    y4:160.8,
...
jishu:function(){
  if(this.data.x1==35.2&&this.data.y1==160.8){
...
var that=this
  ...
        success: function (res) {
    ...
    var x1=100*windowWidth/320;
     var y1=325*windowHeight/568;  
    
    var x2=180*windowWidth/320;
