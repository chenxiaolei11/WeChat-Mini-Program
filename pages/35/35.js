...
mytouchend:function(){
  if (Math.abs(169.6-this.data.x)<6||(Math.abs(156-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(169.6-this.data.x1)<6||(Math.abs(156-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:169.6,
    y1:156,
  ...
  if (Math.abs(169.6-this.data.x2)<6||(Math.abs(156-this.data.y2))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:169.6,
    y2:156,
...
jishu:function(){
  if(this.data.x1==169.6&&this.data.y==156){
