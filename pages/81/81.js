...
mytouchend:function(){
  if (Math.abs(178.4-this.data.x)<6||(Math.abs(162.4-this.data.y))<6){  //当小于2px的可接受阈值时，验证成功
  ...
  if (Math.abs(178.4-this.data.x1)<6||(Math.abs(162.4-this.data.y1))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x1:178.4,
    y1:162.4,
  ...
  if ((Math.abs(178.4-this.data.x2)<6)||((Math.abs(162.4-this.data.y2))<6)){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x2:178.4,
    y2:162.4,
  ...
  if (Math.abs(178.4-this.data.x3)<6||(Math.abs(162.4-this.data.y3))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x3:178.4,
    y3:162.4,
  ...
  if (Math.abs(178.4-this.data.x4)<3||(Math.abs(162.4-this.data.y4))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:178.4,
    y4:162.4,
  ...
  if (Math.abs(178.4-this.data.x5)<3||(Math.abs(162.4-this.data.y5))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x5:178.4,
    y5:162.4,
  ...
  if (Math.abs(178.4-this.data.x6)<3||(Math.abs(162.4-this.data.y6))<3){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x6:178.4,
    y6:162.4,
...
jishu:function(){
  if(this.data.x2==178.4&&this.data.y2==162.4){
