...
mytouchend:function(){
  ...
  if (Math.abs(40-this.data.x4)<6||(Math.abs(160-this.data.y4))<6){  //当小于2px的可接受阈值时，验证成功
    var that=this;  //当小于2px的可接受阈值时，验证成功
    that.setData({
    x4:40,
    y4:160,
...
jishu:function(){
  if(this.data.x3==40&&this.data.y3==160){
...
var that=this
  ...
     
    ...
     var y3=397*windowHeight/568;   
    
    var x4=150*windowWidth/320;
     var y4=437*windowHeight/568;    
          that.setData({
          x:x,
          y:y,
           x1:x1,
